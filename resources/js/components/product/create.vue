                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr v-for="(composicion,key) in form.array_composicion" :key="key">
                                                        <td class="w-25">
                                                            <select class="form-control" v-model="composicion.farmaco"
                                                                    @input="set_nombre(composicion)">
                                                                <option
                                                                    v-for="(farmaco,key) in farmacos"
                                                                    :value="farmaco" :key="key">
                                                                    {{ farmaco.nombre }}
                                                                </option>
                                                            </select>
                                                        ...
                                                        <td class="w-50">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control col-8"
                                                                       ...
                                                                       v-model="composicion.cantidad">
                                                                <select class="form-control col-4"
                                                                        v-model="composicion.unidad">
                                                                    <option selected="selected" value="" disabled>Unidad
                                                                    </option>
                                                                    <option v-for="(unidad,cc) in unidades" :key="cc"
                                                                            :value="unidad">{{ unidad }}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                <input type="checkbox"
                                                                       ...
                                                                       v-model="composicion.principio_activo">
                                                            </div>
...
export default {
    props: ['laboratorios', 'categorias', 'formas', 'tipos', 'unidades', 'farmacos', 'userss'],
    ...
    methods: {
        ...
        //  store_object() { /// copia
        //     let me = this;
        //     // me.$refs.loading.start('Guardando Datos');
        //     me.form.post(me.url.store)
        //         .then(function (response) {
        //             console.log(response)
        //             me.mensaje_susses = response.data.mensaje;
