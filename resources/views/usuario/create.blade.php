@extends('layouts.app',['page' => 'Nuevo Usuario', 'pageSlug' => '', 'section' => 'Usuario'])
@section('content')
<div class="row">
    <div class="col-lg-12">
            <div class="ibox ">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? ' has-danger' : '' }}">
                            <label for="name" class="col-sm-2 form-control-label ">Nombre</label>
                                ...
                                <input type="text" name="name" placeholder="Nombre"
                                 id="name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}"  autofocus>
                        ...
                        <div class="form-group row {{ $errors->has('apellido') ? ' has-danger' : '' }}">
                            <label for="apellido" class="col-sm-2 form-control-label ">Apellido</label>
                                ...
                                <input type="text" name="apellido" placeholder="Apellido"
                                 id="apellido" class="form-control form-control-alternative{{ $errors->has('apellido') ? ' is-invalid' : '' }}" value="{{ old('apellido') }}"  autofocus>
                        ...
                        <div class="form-group row {{ $errors->has('email') ? ' has-danger' : '' }}">
                            <label for="email" class="col-sm-2 form-control-label ">Correo</label>
                                ...
                                <input type="text" name="email" placeholder="Correo"
                                 id="email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}"  autofocus>
                        ...
                        <div class="form-group row {{ $errors->has('ci') ? ' has-danger' : '' }}">
                            <label for="ci" class="col-sm-2 form-control-label ">CI</label>
                                ...
                                <input type="text" name="ci" placeholder="CI"
                                 id="ci" class="form-control form-control-alternative{{ $errors->has('ci') ? ' is-invalid' : '' }}" value="{{ old('ci') }}"  autofocus>
