@extends('layouts.app',['page' => 'Detalle de la Forma de Presentación', 'pageSlug' => 'Forma de Presentación', 'section' => 'Inventario'])
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title ">
                ...
                <div class="col-sm-1">
                        <a href="{{ route('formas.edit', $forma) }}" class="btn btn-success btn-lg ">Editar</a>
                </div>
            </div>
            </div>
