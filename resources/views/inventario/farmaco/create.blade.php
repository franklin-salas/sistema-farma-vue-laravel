@extends('layouts.app',['page' => 'Nueva Farmaco ', 'pageSlug' => 'Farmaco', 'section' => 'Inventario'])
@section('content')
<div class="row">
    <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <form method="post" action="{{ route('farmacos.store') }}" autocomplete="off">
                        @csrf
                    
                        <div class="form-group row {{ $errors->has('nombre') ? ' has-danger' : '' }}">
                            <label for="nombre" class="col-sm-2 form-control-label ">Nombre</label>
                                <div class="col-sm-8">
                                <input type="text" name="nombre" placeholder="nombre del farmaco  ej: Amoxicilina .."
