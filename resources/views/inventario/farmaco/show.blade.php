@extends('layouts.app',['page' => 'Detalle del Farmaco', 'pageSlug' => 'Farmaco', 'section' => 'Inventario'])
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title ">
                ...
                <div class="col-sm-1">
                        <a href="{{ route('farmacos.edit', $farmaco) }}" class="btn btn-success btn-lg ">Editar</a>
                </div>
            </div>
            </div>
