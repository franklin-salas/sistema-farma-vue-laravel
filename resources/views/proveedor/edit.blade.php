@extends('layouts.app',['page' => 'Editar Proveedor', 'pageSlug' => '', 'section' => 'Proveedor'])
@section('content')
<div class="row">
    <div class="col-lg-12">
            <div class="ibox ">
                        ...
                        <div class="form-group row {{ $errors->has('nombre') ? ' has-danger' : '' }}">
                            <label for="nombre" class="col-sm-2 form-control-label ">Nombre</label>
                                ...
                                <input type="text" name="nombre" placeholder="Nombre"
                                 id="nombre" class="form-control form-control-alternative{{ $errors->has('nombre') ? ' is-invalid' : '' }}" value="{{old('nombre', $proveedor->nombre)}}" required autofocus>
                        ...
                        <div class="form-group row {{ $errors->has('razon_social') ? ' has-danger' : '' }}">
                            <label for="razon_social" class="col-sm-2 form-control-label ">Razón Social</label>
                                ...
                                <input type="text" name="razon_social" placeholder="Razón Social"
                                 id="razon_social" class="form-control form-control-alternative{{ $errors->has('razon_social') ? ' is-invalid' : '' }}" value="{{old('razon_social', $proveedor->razon_social)}}" required autofocus>
                                 @include('alerts.feedback', ['field' => 'razon social'])
                                </div>
                        </div>
                        ...
                        <div class="form-group row {{ $errors->has('nit') ? ' has-danger' : '' }}">
                            <label for="nit" class="col-sm-2 form-control-label ">Nit</label>
                                ...
                                <input type="text" name="nit" placeholder="Nit"
                                 id="nit" class="form-control form-control-alternative{{ $errors->has('nit') ? ' is-invalid' : '' }}" value="{{old('nit', $proveedor->nit)}}"  autofocus>
                        ...
                        <div class="form-group row {{ $errors->has('direccion') ? ' has-danger' : '' }}">
                            <label for="direccion" class="col-sm-2 form-control-label ">Dirección</label>
                                ...
                                <input type="text" name="direccion" placeholder="Dirección"
                                 id="direccion" class="form-control form-control-alternative{{ $errors->has('direccion') ? ' is-invalid' : '' }}" value="{{ old('direccion',$proveedor->direccion) }}"  autofocus>
                        ...
                        <div class="form-group row {{ $errors->has('telefono') ? ' has-danger' : '' }}">
                            <label for="direccion" class="col-sm-2 form-control-label ">Teléfono</label>
                                ...
                                <input type="text" name="telefono" placeholder="Teléfono"
                                 id="telefono" class="form-control form-control-alternative{{ $errors->has('telefono') ? ' is-invalid' : '' }}" value="{{ old('telefono',$proveedor->telefono) }}"  autofocus>
