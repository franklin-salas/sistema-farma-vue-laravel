@extends('layouts.app',['page' => 'Lista de Notas de Salida', 'pageSlug' => 'Salidas', 'section' => 'Movimiento'])
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-title ">
                ...
                <div class="col-lg-4">
                        <a href="{{route('salida.create')}}" class="btn btn-primary btn-lg ">Nuevo</a>
                </div>
            </div>
            <div class="ibox-content">
                ...
                <table class="table table-stripped toggle-arrow-tiny">
                    ...
                    <tr>
                        ...
                        <a href="{{ route('salida.edit', $nota->id) }}" class="btn btn-primary btn-circle" type="button" title="Detalle"><i class="fa fa-search"></i>

                        </a>
                   
                        <form action="{{ route('salida.destroy', $nota->id) }}" method="post" class="d-inline">
                            @csrf
                            @method('delete')
